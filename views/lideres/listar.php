<?php
// Vista: views/lideres/listar.php
...
<div class="page-header-container">
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-modern">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Líder amigo</li>
        </ol>
    </nav>
</div>

<div class="d-flex justify-content-end mb-3">
    <a href="index.php?url=lider/create" class="btn btn-primary me-2 shadow-sm">
...
$(document).ready(function() {
    var dataTable = $('#lookup').DataTable({
        ...
        "autoWidth": false,
        "ajax":{
            url :"index.php?url=lider/ajaxListar", 
            type: "post",
            error: function(){ 
        ...
        if(id.length === 0) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'index.php?url=lider/delete',
                        method: 'POST',
                        data: {id: id},
                        dataType: 'json',
