...
<div class="d-flex justify-content-end mb-3">
    <a href="index.php?url=zona/create" class="btn btn-primary me-2 shadow-sm">
...
$(document).ready(function() {
    var dataTable = $('#lookup').DataTable({
        ...
        "autoWidth": false,
        "ajax":{
            url :"index.php?url=zona/ajaxListar", 
            type: "post",
            error: function(){ 
