    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form id="form1" name="form1" autocomplete="off">
                <input type="hidden" name="txtId" value="<?php echo $votante['id_votante']; ?>">

                <h5 class="mb-3 text-muted border-bottom pb-2">Información Personal</h5>
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="txtCed_votante" name="txtCed_votante" value="<?php echo $votante['ced_votante']; ?>" readonly>
                            <label for="txtCed_votante">No. de Cédula</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="txtNom_votante" name="txtNom_votante" value="<?php echo $votante['nom_votante']; ?>" required maxlength="100">
                            <label for="txtNom_votante">Nombres y Apellidos *</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="txtDir_votante" name="txtDir_votante" value="<?php echo $votante['dir_votante']; ?>" placeholder="Dirección">
                            <label for="txtDir_votante">Dirección</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="txtBarrio_votante" name="txtBarrio_votante" value="<?php echo $votante['barrio_votante']; ?>" placeholder="Barrio">
                            <label for="txtBarrio_votante">Barrio</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="txtComuna_votante" name="txtComuna_votante" value="<?php echo $votante['comuna_votante']; ?>" placeholder="Comuna">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="email" class="form-control" id="txtEmail_votante" name="txtEmail_votante" value="<?php echo $votante['email_votante']; ?>" placeholder="Email">
                            <label for="txtEmail_votante">Email</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="txtCel_votante" name="txtCel_votante" value="<?php echo $votante['cel_votante']; ?>" placeholder="Celular">
                        ...
                        <div class="form-floating">
                            <select class="form-select" id="CboLider" name="CboLider" required>
                                ...
                                <?php foreach($lideres as $lider): ?>
                                    <option value="<?php echo $lider['ced_lider']; ?>" <?php if($votante['ced_lider'] == $lider['ced_lider']) echo 'selected'; ?>>
                ...
                <h5 class="mt-4 mb-3 text-muted border-bottom pb-2">Información de Votación</h5>
                 <div class="row g-3">
                    ...
                    <div class="col-md-12">
                         <div class="form-floating">
                            <input type="text" class="form-control" id="txtNom_puesto" name="txtNom_puesto" value="<?php echo $votante['nom_puestov']; ?>" readonly>
                            <label for="txtNom_puesto">Nombre Puesto</label>
                        </div>
                    </div>
                    <div class="col-md-8">
                         <div class="form-floating">
                            <input type="text" class="form-control" id="txtDir_puesto" name="txtDir_puesto" value="<?php echo $votante['dir_puestov']; ?>" readonly>
                            <label for="txtDir_puesto">Dirección Puesto</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="txtNum_mesa" name="txtNum_mesa" value="<?php echo $votante['mesa_votante']; ?>" placeholder="Mesa">
...
$(document).ready(function() {
    ...
    var currentCargaZona = "<?php echo $votante['zona_votante']; ?>";
    var currentCargaPuesto = "<?php echo $votante['puesto_votante']; ?>";
