<?php
// Vista: views/votantes/listar.php
...
<div class="d-flex justify-content-end mb-3">
    <a href="index.php?url=votante/create" class="btn btn-primary me-2 shadow-sm">
        <i class="bi bi-plus-lg"></i> Nuevo Votante
    </a>
        ...
        if(id.length === 0) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'index.php?url=votante/delete',
                        method: 'POST',
                        data: {id: id},
                        dataType: 'json',
